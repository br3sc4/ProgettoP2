...
MotoElettrica::MotoElettrica(string targa, string posizione, unsigned long km, double capacitaBatteria, double capacitaAttuale,
                             VelocitaRicarica caricaSupportata, unsigned int potenza, unsigned short numeroMotori, bool inCarica, Colonnina colonninaAttuale,
