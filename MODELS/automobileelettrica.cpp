...
AutomobileElettrica::AutomobileElettrica(string targa, string posizione, unsigned long km, unsigned short potenza, unsigned short numeroMotori,
                                         double capacitaBatteria, double capacitaAttuale, VelocitaRicarica caricaSupportata, bool inCarica,
