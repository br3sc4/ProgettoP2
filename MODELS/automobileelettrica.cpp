...
AutomobileElettrica::AutomobileElettrica(string targa, string posizione, double km,
                                         ...
                                         bool inCarica, Colonnina colonninaAttuale, u_int numeroPosti, u_int ingombro):
